      ...
      <div className={styles.shell}>
        ...
        <article className={styles.card}>
          ...
          <section className={styles.section}>
            ...
            <p>Indian equity logos load from Upstox. US-linked token logos load from Parqet, and crypto or commodity token logos load from CoinCap. IPO company logos are loaded from Chittorgarh’s image service. Loading these images sends ordinary connection information, such as your IP address, to that service; we omit referrer information and cross-origin credentials. Research links open Chittorgarh in a new tab. We do not attach your account, portfolio, PAN, or payment information to these requests or links.</p>
          </section>
