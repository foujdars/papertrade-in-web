...
type NativeAlertPlugin = {
  ...
  consumeNotifications: () => Promise<{ notifications?: Array<{ id:string;title:string;body:string;url:string;createdAt:number;kind:"ipo"|"allotment"|"portfolio"|"practice"|"trade"|"session" }> }>;
