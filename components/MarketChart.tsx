  ...
  return (
    <div className="chart-stack lightweight-stack">
      <div className="price-chart-wrap lightweight-chart-wrap">
        ...
        {indicators["anchored-vwap"] && !studySettings["anchored-vwap"]?.hidden && <AnchoredVwap key={`${instrument.instrumentKey}:${timeframe}:anchored-vwap`} candles={dataRef.current} chart={chartApi.current} timeframe={timeframe} instrumentKey={instrument.instrumentKey} activeTool={activeTool} replay={isReplay} hoverTime={hoveredCandle?.scope === legendScope ? hoveredCandle.time : null} hoverY={priceCursor?.y ?? null} refreshRef={anchoredVwapRefreshRef} />}
