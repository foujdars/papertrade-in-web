        ...
        <main className="auth-screen">
          <section className="auth-card">
            ...
            {!nativePlatform && <div className="auth-download-options">
              <a className="auth-download-link" href="/downloads/PaperTrade-IN-v1.19-beta.apk" download><Download size={17} /><span><b>Download Android beta</b><small>Official APK from papertrade.site · v1.19</small></span></a>
