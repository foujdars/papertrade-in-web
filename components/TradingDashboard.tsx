      ...
      {!holdingsOpen && !homeOpen && <div className={`workspace section-${activeNavigationSection} ${desktopOrderPanelOpen ? "" : "order-panel-collapsed"}`}>
        ...
        <section className="chart-area">
          ...
          <div className="chart-controls">
            ...
            <button type="button" className={`compact-selector-trigger chart-functions-trigger ${showChartFunctions ? "active" : ""}`} onClick={() => { setShowTimeframeMenu(false); setShowChartFunctions(true); }} aria-label="Functions" title="Indicators" aria-haspopup="dialog"><svg className="chart-fx-mark" viewBox="0 0 16.61 17.97" aria-hidden="true"><path fill="currentColor" d="M1.23 17.82q-.15 0-.32-.03-.16-.03-.32-.07-.15-.04-.27-.09t-.17-.1v-.07q.04-.1.07-.26.04-.16.07-.32.04-.16.07-.31t.04-.26h.18q.25.25.53.43.29.18.59.18.22 0 .41-.17.19-.16.34-.48t.24-.77q.09-.46.09-1.04 0-.51-.01-1.22l-.02-1.5-.02-1.62V8.55q0-.67.01-1.37t.03-1.34.04-1.17.04-.87q.03-.56.19-1.04.16-.49.4-.9.23-.4.53-.72T4.59.6t.64-.34q.31-.11.57-.11.15 0 .33.03.17.03.34.07t.29.09q.13.06.18.09v.08q-.04.11-.08.26-.05.15-.09.32t-.08.32-.05.25h-.19q-.24-.24-.53-.43-.29-.18-.58-.18-.22 0-.41.16-.2.17-.35.49t-.24.78-.09 1.04q0 .52.01 1.2 0 .67.01 1.34l.02 1.26v.92q0 .37-.01.91l-.02 1.15q-.01.61-.03 1.23-.01.62-.03 1.16t-.03.94q-.01.41-.02.57-.04.85-.36 1.52-.31.67-.74 1.14-.44.46-.93.71t-.89.25m7.44-1.95h-1.1l1.49-8.51H7.99l.05-.33 1.12-.25.08-.44q.26-1.47.89-2.16.62-.69 1.68-.69.3 0 .52.04.23.04.4.09l-.23 1.29h-.33l-.12-.75q-.19-.14-.56-.14-.23 0-.39.1-.16.11-.28.32t-.21.54-.18.8l-.19 1.02h1.38l-.09.56h-1.38Zm3.54-4.43q-.21.21-.35.36-.13.15-.21.27-.08.11-.11.2-.03.1-.03.18 0 .1.07.16.08.06.2.09l-.05.3h-1.22q-.04-.03-.07-.11-.03-.07-.03-.17t.05-.2q.05-.11.15-.25.11-.14.28-.32t.42-.41l1.8-1.67-1.13-2.61-.71-.16.05-.3h1.64l.95 2.36.82-.77q.42-.41.59-.64.18-.23.18-.39 0-.06-.04-.1-.04-.03-.1-.06l-.12-.06q-.07-.02-.13-.04l.05-.3h1.17q.06.05.1.12.03.07.03.17 0 .39-.9 1.25l-1.42 1.32 1.27 2.9.76.14-.05.3h-1.69l-1.1-2.64Z"/></svg></button>
